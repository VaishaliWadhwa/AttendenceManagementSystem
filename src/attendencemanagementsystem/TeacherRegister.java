...
public class TeacherRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Do remember as it is required at the time of login.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            stmt.executeUpdate("insert into teacher values ('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"
